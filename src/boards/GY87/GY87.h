/*
  GY87.h - Board class for common GY-87 10-DOF marketplace modules.

  Typical advertised chips:
    * MPU-6050 accel + gyro at 0x68/0x69
    * BMP180 pressure + temperature at 0x77
    * HMC5883L compass at 0x1E, often replaced by QMC5883L at 0x0D

  The compass is usually wired behind the MPU-6050 auxiliary I2C pins, so this
  class enables MPU-6050 bypass before probing it.
*/
#ifndef ARDUINONRF_IMU_GY87_H
#define ARDUINONRF_IMU_GY87_H
...
class GY87 {
 public:
  ...
  bool begin(TwoWire& wire = Wire) {
    bool ok68 = beginI2C(wire, bmp180::kAddr, mpu6050::kAddrAD0Low);
    if (ok68 || imuOk_) {
      return ok68;
    }
    return beginI2C(wire, bmp180::kAddr, mpu6050::kAddrAD0High);
  }
