...
#undef min
#define LSM6DSV320X_RESTORE_MIN
#endif
#if defined(__cplusplus) && defined(max)
#pragma push_macro("max")
#undef max
#define LSM6DSV320X_RESTORE_MAX
#endif
#include <math.h>
#ifdef LSM6DSV320X_RESTORE_MIN
#pragma pop_macro("min")
#undef LSM6DSV320X_RESTORE_MIN
#endif
#ifdef LSM6DSV320X_RESTORE_MAX
#pragma pop_macro("max")
#undef LSM6DSV320X_RESTORE_MAX
#endif
